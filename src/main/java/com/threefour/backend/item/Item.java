...
public class Item {
    ...
    public @NotNull(message = "Item ID is required") Long getItemId() {
        return itemId;
    }
    ...
    public @NotBlank(message = "Item name is required") @Size(min = 3, max = 100, message = "Item name must be between 3 and 100 characters") String getItemName() {
        return itemName;
    }
